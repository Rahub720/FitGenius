...
class LogFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val fitgeniusAdapter = FitGeniusAdapter(view.context, foods)
        foodRecyclerView.adapter = fitgeniusAdapter
        ...
        lifecycleScope.launch {
            (activity?.application as FitGeniusApplication).db.foodDao().getAll().collect { databaseList ->
                databaseList.map { entity ->
                    ...
                    fitgeniusAdapter.notifyDataSetChanged()
                }
            }
        }
    ...
    fun getAdapter(): FitGeniusAdapter {
        return foodRecyclerView.adapter as FitGeniusAdapter
    }
